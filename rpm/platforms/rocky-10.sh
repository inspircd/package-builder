...
export PLATFORM_NAME="Rocky Linux 10"
export PLATFORM_CONTAINER="rockylinux/rockylinux:10"

export CORE_BUILD_DEPS="libpsl-devel pkgconfig systemd"
export CORE_RUNTIME_DEPS="libpsl publicsuffix-list systemd"
